...
var player = 12710197;
var playerBucket=2600;
page.open('http://www.uschess.org/datapage/gamestats.php?memid=' + player + '&dkey='+ playerBucket + '&drill=G', function() {
    'use strict';
    ...
    var playerObjects = page.evaluate(function() {
        ...
        function isKamksy (array) {
            for (i = 0; i < array.length; i ++) {
                if (array[i]['playerID'] === '125284`59' && array[i]['winLoss'] === 'W') { //if player beat Kamsky, return true
                    return true ;
                }
            }
            return false;
